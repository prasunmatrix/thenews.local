                                                        ...
                                                        <div class="tg-sharepost col-md-12" style="padding-top: 0px; padding-bottom: 40px; border-bottom: 0px;">
                                                            ...
                                                            <ul class="tg-socialicons">
                                                                ...
                                                                <li class="tg-facebook">
                                                                    <a onclick="window.open('https://www.facebook.com/sharer/sharer.php?u=<?= site_url() ?>live_news/view/<?= $news_details[0]['rand_id']; ?>', '_blank', 'location=yes,height=570,width=520,scrollbars=yes,status=yes');" href="#"><i class="icon-facebook-1"></i></a>
                                                                </li>
                                                                <li class="tg-twitter">
                                                                    <a onclick="window.open('https://twitter.com/intent/tweet?text=<?= site_url() ?>live_news/view/<?= $news_details[0]['rand_id']; ?>', '_blank', 'location=yes,height=570,width=520,scrollbars=yes,status=yes');" href="#"><i class="icon-twitter-1"></i></a>
                                                                </li>
                                                                <li class="tg-whatsapp">
                                                                    <a data-action="share/whatsapp/share" onclick="window.open('https://api.whatsapp.com/send?text=<?= site_url() ?>live_news/view/<?= $news_details[0]['rand_id']; ?>', '_blank', 'location=yes,height=570,width=520,scrollbars=yes,status=yes');" href="#"><i class="icon-whatsapp" style="padding-left:2px;"></i></a>
                                                                </li>
                                                                <li class="tg-linkedin">
                                                                    <a onclick="window.open('https://www.linkedin.com/shareArticle?mini=true&url=<?= site_url() ?>live_news/view/<?= $news_details[0]['rand_id']; ?>', '_blank', 'location=yes,height=570,width=520,scrollbars=yes,status=yes');" href="#"><i class="icon-linkedin22" style="padding-left:3px;"></i></a>
                                                                </li>
                                                                <li class="tg-linkedin">
                                                                    <a onclick="window.open('https://www.linkedin.com/shareArticle?mini=true&url=<?= site_url() ?>live_news/view/<?= $news_details[0]['rand_id']; ?>', '_blank', 'location=yes,height=570,width=520,scrollbars=yes,status=yes');" href="#"><i class="icon-book-bookmark2" style="padding-left:3px;"></i></a>
                                                                </li>
                                                            </ul>
                        ...
                        foreach($news_posts as $post){
                            ...
                            if($count>1){
                                if($this->session->userdata('normal_user')){
                                    if($this->session->userdata('normal_subscribed_plan') && $this->session->userdata('normal_subscription_end_date')){
                                        if(date('Y-m-d',time())<$this->session->userdata('normal_subscription_end_date')){
                                            ?>
                                                ...
                                                <div class="container">
                                                    <div class="row">
                                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                            ...
                                                            if ($post['l_thumbnail'] != "") {
                                                                ?>
                                                                <figure class="tg-processimg col-md-6"><img src="<?= S3_URL . S3_BUCKET_NAME ?>/images/<?= $post['l_thumbnail']; ?>" alt="image description"></figure>
                                                                <div class="tg-processcontent  col-md-6">
                                                                    <?php
                                                                } else {
                                                                    ?>
                                            ...
                                            echo "<center><a href='#' onclick='openLoginBanner(2)' class='btn btn-default'>" . lang('it_seems_your_subscription_expired_please_renew_the_subscription_to_continue_the_news') . "</a></center>";
                                            echo "<br>";
                                            echo "<br>";
                                            echo "</div>";
                                            goto endLoop;
                                        ...
                                        echo "<br>";
                                        echo "<div class='col-md-12'>";
                                        echo "<center><a href='#' onclick='openLoginBanner(2)' class='btn btn-default'>" . lang('please_subscribe_to_view_full_news') . "</a></center>";
                                        echo "<br>";
                                        echo "<br>";
                                        echo "</div>";
                                        goto endLoop;
                                    ...
                                    echo "<br>";
                                    echo "<div class='col-md-12'>";
                                    echo "<center><a href='#' onclick='openLoginBanner(1)' class='btn btn-default'>" . lang('please_login_to_view_full_news') . "</a></center>";
                                    echo "<br>";
                                    echo "<br>";
                                    echo "</div>";
                                    goto endLoop;
