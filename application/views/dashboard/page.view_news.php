                                        ...
                                        <form method="post" class="news_type_form">
                                            <div class="col-md-8 no-padding">                                                
                                                <div class="panel panel-default">
                                                    <div class="panel-heading"><?php if(isset($news_details[0]['news_title'])){ echo $news_details[0]['news_title']; } ?></div>
                                                ...
                                                <div class="col-md-12 no_padding">
                                                    <div class="panel panel-default">
                                                        <div class="panel-heading">
                                                            ...
                                                            ?>
                                                                <span class="pull-right"><a href="<?= site_url().DASHBOARD_DIR_NAME ?>news/edit/<?= $news_details[0]['rand_id']; ?>"><i class="fa fa-pencil"></i></a></span>
                                                            <?php
                                                                }
                                                            ?>
                                                        </div>
                                                        <div class="panel-body">
                                                            <div class="col-md-12" style="padding: 0px;">
                                                                <div class="col-md-5">
                                                                    <p class="pull-right"><?= lang('news_type'); ?></p>
                                                                </div>
                                                                <div class="col-md-7">
                                                                    <?php
                                                                        ...
                                                                        if(!empty($news_types)){
                                                                            foreach($news_types as $type){
                                                                                if($news_details[0]['news_type_id']==$type['news_type_id']){                                                                                    
                                                                                    $news_type = "<strong><a href='". site_url().DASHBOARD_DIR_NAME."news_types/view/".$type['rand_id']."'>".$type['news_type_title']."</a></strong>";
                                                                                }
                                                                            }
                                                                        }
                                                                        echo $news_type;
