                            ...
                            <section class="scrollable wrapper no-padding">
                                <div id="news_section" class="wrapper">
                                    <div class="col-md-12 no-padding">
                                        <a href="<?= site_url().DASHBOARD_DIR_NAME.'exclusive_news/add'?>" class="btn btn-dark"><?= lang('add_new_exclusive_news'); ?></a>
                                    </div>
                                    <div class="col-md-12 no-padding">
                        ...
                        <script>                            
                            ...
                            function get_news_datatable(){
                                table = $('.news_datatable').DataTable({ 
                                    ...
                                    "ajax": {
                                       "url": "<?= site_url(); ?>api/news/list_exclusive_news_datatable",
                                       "type": "POST"
                                    },
                                    "columnDefs": [
                                        { 
