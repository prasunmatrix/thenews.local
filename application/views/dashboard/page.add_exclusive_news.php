                        ...
                        <section class="vbox bg-gradient content-vbox">
                            <header class="header b-b b-t b-light bg-light lter">
                                <ul class="breadcrumb no-border no-radius">
                                    ...
                                    <li><a href="<?= site_url().DASHBOARD_DIR_NAME ?>exclusive_news"><i class="fa fa-newspaper-o"></i> &nbsp;<?= lang('exclusive_news'); ?></a></li>
                                    <?php
                                        if($this->uri->segment(4)=='add'){
                                    ?>
                                        <li class="active"><i class="fa fa-plus"></i> &nbsp;<?= lang('add_new_exclusive_news'); ?></li>
                                    <?php
                                        }
                                        else{
                                    ?>
                                        <li class="active"><i class="fa fa-pencil"></i> &nbsp;<?= lang('edit_new_exclusive_news'); ?></li>
                                    <?php        
                                        }
                                    ?>
                                </ul>                                
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-heading">
                                                        <?php
                                                            if($this->uri->segment(4)=='add'){
                                                        ?>
                                                            <i class="fa fa-plus"></i> &nbsp;<?= lang('add_new_exclusive_news'); ?>
                                                        <?php
                                                            }
                                                            else{
                                                        ?>
                                                            <i class="fa fa-pencil"></i> &nbsp;<?= lang('edit_new_exclusive_news'); ?>
                                                        <?php        
                                                            }
                                                        ?>
                                                    </div>
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="col-md-12" style="padding: 0px;margin-bottom: 10px;">
                                                            <div class="input-group">
                                                                ...
                                                                <select class="form-control" name="parent_news">
                                                                    <option value=""><?= lang('select_parent_news'); ?></option>
                                                                    <?php
                                                                        if(!empty($exclusive_news)){
                                                                            foreach ($exclusive_news as $type){
                                                                                if($type['news_id']==$news_details[0]['parent_news_id']||$type['news_id']==$news_id){
                                                                    ?>
                                                                    <option value="<?= $type['news_id']; ?>" selected><?= $type['news_title']; ?></option>
                                                                    <?php   
                                                                                }
                                                                                else{
                                                                    ?>
                                                                        <option value="<?= $type['news_id']; ?>"><?= $type['news_title']; ?></option>
                                                                    <?php   
                                                                                }                                                                    
                                                                            }
                                                                        }
                                                ...
                                                <div class="panel panel-default">
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="col-md-12" style="padding: 0px;margin-bottom: 10px;">
                                                            ...
                                                            <a href="<?= site_url() . DASHBOARD_DIR_NAME ?>exclusive_news" class="btn btn-default"><?= lang('cancel'); ?></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <script>                            
                            $(".news_form").submit(function(e){
                                    ...
                                    $.ajax({
                                        ...
                                        contentType: false,
                                        dataType: 'json',
                                        url: "<?= site_url() ?>api/news/save_exclusive_news_details",
                                        success: function (data) {
                                            if (data.status) {
                                                alertify.alert("<?= lang('notifications'); ?>", data.message , function(){
                                                    window.location = "<?= site_url().DASHBOARD_DIR_NAME ?>exclusive_news/view/"+data.next;
