...
<?php } ?>
                        ...
                        <section class="vbox bg-gradient content-vbox">
                            ...
                            <section class="scrollable wrapper no-padding">
                                <div id="video_section" class="wrapper">
                                    <div class="col-md-12 no-padding">
                                        <a href="<?= site_url().DASHBOARD_DIR_NAME.'videos/add'?>" class="btn btn-dark"><?= lang('add_new_video'); ?></a>
                                    </div>
                                    <div class="col-md-12 no-padding">
                                        <section class="panel panel-default no-padding" style="margin-top: 10px;">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped m-b-none video_datatable">
                                                    <thead>
                                                        <tr>
                        ...
                        <script>                            
                            ...
                            function get_video_datatable(){
                                table = $('.video_datatable').DataTable({ 
                                    "processing": true, 
                                    "serverSide": true,
                                    "destroy" : true,
                                    "searching" : true,
                                    ...
                                    "ajax": {
                                       "url": "<?= site_url(); ?>api/videos/list_videos_datatable",
                                       "type": "POST"
                                    },
                                    "columnDefs": [
                                        { 
                                ...
                                $(".video_datatable_paginate").css("margin-top","0px");
                            ...
                            ?>
                                function delete_video(id){
                                    if(id){
                                        alertify.confirm("<?= lang('are_you_sure'); ?>", "<?= lang('do_you_want_to_delete_video'); ?>", function(){
                                            $.ajax({
                                                data: {id:id},
                                                type: "post",
                                                dataType: 'json',
                                                url: "<?= site_url() ?>api/videos/delete_video_details",
                            ...
                            ?>
                                function changeHomeSliderStatus(id){
                                    ...
                                    $.ajax({
                                        ...
                                        type: "post",
                                        dataType: 'json',
                                        url: "<?= site_url() ?>api/video/change_video_home_slider_status",
                                        success: function (data) {
                                            if(data.status){
