                                    ...
                                    <div class="col-md-12 no-padding">
                                        <form method="post" class="news_type_form">
                                            <div class="col-md-8 no-padding">                                                
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-heading">
                                                        <?= lang('exclusive_news_posts'); ?>
                                                         <span class="pull-right"><a href="<?= site_url().DASHBOARD_DIR_NAME ?>exclusive_news/add/<?= $news_details[0]['news_id']; ?>"><i class="fa fa-plus"></i> &nbsp;<?= lang('add_posts'); ?></a></span> 
                                                    </div>
                                                    <div class="panel-body">
                                                ...
                                                <div class="col-md-12 no_padding">
                                                    <div class="panel panel-default">
                                                        <div class="panel-heading">
                                                            ...
                                                            ?>
                                                                <span class="pull-right"><a href="<?= site_url().DASHBOARD_DIR_NAME ?>exclusive_news/edit/<?= $news_details[0]['rand_id']; ?>"><i class="fa fa-pencil"></i></a></span>
                                                            <?php
                                                                }
                                                            ?>
                                                        </div>
                                                                        ...
                                                                        if(!empty($news)){
                                                                            foreach($news as $type){
                                                                                if($news_details[0]['parent_news_id']==$type['news_id']){                                                                                    
                                                                                    $news_type = "<strong><a href='". site_url().DASHBOARD_DIR_NAME."exclusive_news/view/".$type['rand_id']."'>".$type['news_title']."</a></strong>";
                                                                                }
                                                                            }
                                                                        }
                                                                        echo $news_type;
                        ...
                        <script>                            
                            ...
                            function get_news_datatable(){
                                table = $('.news_datatable').DataTable({ 
                                    ...
                                    "ajax": {
                                       "url": "<?= site_url(); ?>api/news/list_exclusive_sub_news_datatable",
                                       "data": {exclusive_news_id:<?= $news_details[0]['news_id']; ?>},
                                       "type": "POST"
                                    },
                                    "columnDefs": [
                                        { 
                                    ...
                                    if(id){
                                        alertify.confirm("<?= lang('are_you_sure'); ?>", "<?= lang('do_you_want_to_delete_news'); ?>", function(){
                                            $.ajax({
                                                ...
                                                type: "post",
                                                dataType: 'json',
                                                url: "<?= site_url() ?>api/news/delete_exclusive_news_details",
