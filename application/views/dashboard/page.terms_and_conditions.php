...
<?php } ?>
                        ...
                        <section class="vbox bg-gradient content-vbox">
                            <header class="header b-b b-t b-light bg-light lter">
                                <ul class="breadcrumb no-border no-radius">
                                    ...
                                    <li><a href="<?= site_url().DASHBOARD_DIR_NAME ?>settings/terms_and_conditions"><i class="fa fa-tags"></i> &nbsp;<?= lang('terms_and_conditions'); ?></a></li>
                                    <li class="active"><i class="fa fa-pencil"></i> &nbsp;<?= lang('edit_terms_and_conditions'); ?></li>
                                </ul>                                
                            </header>
                            <section class="scrollable wrapper no-padding">
                                <div id="my_account" class="wrapper">
                                    <div class="col-md-12 no-padding">
                                        <form method="post" class="terms_and_conditions_form">
                                            <div class="col-md-9 no-padding">
                                                <div class="panel panel-default">
                                                    <div class="panel-body no-padding">
                                                        <div class="col-md-12 no-padding">
                                                            <div id="editor" style="margin-bottom: 0px;"><div id='edit' style="margin-top: 0px;margin-bottom: 0px;"><?php if(isset($terms[0]['terms_and_conditions'])){ echo $terms[0]['terms_and_conditions']; } ?></div></div>
                                                            <textarea class="form-control" style="display: none;" id="terms" name="terms"><?php if(isset($terms[0]['terms_and_conditions'])){ echo $terms[0]['terms_and_conditions']; } ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="panel-body">
                                                            <div class="col-md-12" style="padding: 0px;margin-bottom: 10px;">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="seo_title" name="seo_title" placeHolder="<?= lang('seo_title'); ?>" value="<?php  if(isset($terms[0]['seo_title'])){ echo $terms[0]['seo_title']; }?>">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12" style="padding: 0px;margin-bottom: 10px;">
                                                                <div class="input-group">
                                                                    ...
                                                                    <div id="MyPillbox" class="pillbox clearfix">
                                                                        <?php
                                                                            $keywords = array();
                                                                            if(isset($terms[0]['seo_keywords'])){                                                                             
                                                                                $keywords = json_decode($terms[0]['seo_keywords']);
                                                                            }
                                                                        ?>
                                                                        <ul>
                                                                            <?php
                                                            ...
                                                            <div class="col-md-12" style="padding: 0px;margin-bottom: 10px;">
                                                                <div class="input-group">
                                                                    ...
                                                                    <textarea class="form-control" rows="5" name="seo_desc" placeholder="<?= lang('seo_descriptions'); ?>"><?php  if(isset($terms[0]['seo_desc'])){ echo $terms[0]['seo_desc']; }?></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12" style="padding: 0px;margin-bottom: 10px;">
                        ...
                        <script>                            
                            $(".terms_and_conditions_form").submit(function(e){
                                ...
                                form = $('.terms_and_conditions_form')[0];
                                ...
                                $.ajax({
                                    ...
                                    contentType: false,
                                    dataType: 'json',
                                    url: "<?= site_url() ?>api/settings/save_terms_and_conditions",
                            ...
                            $(function () {
                                $("#seo_title").focus();
                                $('#edit').froalaEditor({
                                    placeholderText: "<?= lang('write_terms_and_conditions_here'); ?>",
                                ...
                                $('.fr-wrapper a[href^="https://www.froala.com/wysiwyg-editor?k=u"]').html("<?= lang('write_terms_and_conditions_here'); ?>");
