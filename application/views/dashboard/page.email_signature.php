                        ...
                        <section class="vbox">          
                            <section class="scrollable padder">
                                <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                                    ...
                                    <li class="active"><i class="fa fa-envelope-o"></i> &nbsp;<?= lang('email_signature'); ?></li>
                                </ul>
                                <div class="col-md-12" style="margin-top:10px;padding: 0px;">
                                    <div class="col-md-8">
                                        <div class="panel panel-default">
                                            <div class="panel-heading"><i class="fa fa-envelope-o"></i> &nbsp;<?= lang('email_signature'); ?></div>
                                            <div class="panel-body">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class=""><?php if($config['config_value']!=""){ echo $config['config_value']; } else{ echo "--"; } ?></div>
                                                </div>
                                                <?php                
                                                            }                                                    
                                                        }                                                    
                                    ...
                                    <div class="col-md-4">
                                        <div class="col-md-12" style="padding: 0px;">
                                            <div class="panel panel-default">
                                                <div class="panel-heading">
                                                    ...
                                                    <?php
                                                        if($this->permissions_model->check('email_signature','edit')){
                                                    ?>
                                                        <span class="pull-right"><a href="<?= site_url().DASHBOARD_DIR_NAME ?>general_settings/email_signature/edit"><i class="fa fa-pencil"></i></a></span>
                                                    <?php
                                                        }
                                                    ?>
                                        ...
                                        <div class="col-md-12" style="padding: 0px;">
                                            <div class="panel panel-default">
                                                ...
                                                <div class="panel-body">
                                                    <?= lang('this_text_would_be_used_as_signature_text_while_sending_all_emails'); ?>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
