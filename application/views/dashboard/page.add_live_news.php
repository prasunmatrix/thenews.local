                        ...
                        <section class="vbox bg-gradient content-vbox">
                            <header class="header b-b b-t b-light bg-light lter">
                                <ul class="breadcrumb no-border no-radius">
                                    ...
                                    ?>
                                        <li class="active"><i class="fa fa-plus"></i> &nbsp;<?= lang('add_new_live_news'); ?></li>
                                    <?php
                                        }
                                        else{
                                    ?>
                                        <li class="active"><i class="fa fa-pencil"></i> &nbsp;<?= lang('edit_new_live_news'); ?></li>
                                    <?php        
                                        }
                                    ?>
                                </ul>                                
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-heading">
                                                        <?php
                                                            if($this->uri->segment(4)=='add'){
                                                        ?>
                                                            <i class="fa fa-plus"></i> &nbsp;<?= lang('add_new_live_news'); ?>
                                                        <?php
                                                            }
                                                            else{
                                                        ?>
                                                            <i class="fa fa-pencil"></i> &nbsp;<?= lang('edit_new_live_news'); ?>
                                                        <?php        
                                                            }
                                                        ?>
                                                    </div>
                                                ...
                                                <div class="panel panel-default">
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="col-md-12" style="padding: 0px;margin-bottom: 10px;">
                                                            ...
                                                            <a href="<?= site_url() . DASHBOARD_DIR_NAME ?>live_news" class="btn btn-default"><?= lang('cancel'); ?></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <script>                            
                            $(".news_form").submit(function(e){
                                    ...
                                    $.ajax({
                                        ...
                                        contentType: false,
                                        dataType: 'json',
                                        url: "<?= site_url() ?>api/news/save_live_news_details",
                                        success: function (data) {
                                            if (data.status) {
                                                alertify.alert("<?= lang('notifications'); ?>", data.message , function(){
                                                    window.location = "<?= site_url().DASHBOARD_DIR_NAME ?>live_news/view/"+data.next;
