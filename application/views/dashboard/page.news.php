                            ...
                            <section class="scrollable wrapper no-padding">
                                <div id="news_section" class="wrapper">
                                    <div class="col-md-12 no-padding">
                                        <a href="<?= site_url().DASHBOARD_DIR_NAME.'news/add'?>" class="btn btn-dark"><?= lang('add_new_news'); ?></a>
                                    </div>
                                    <div class="col-md-12 no-padding">
                        ...
                        <script>                            
                            ...
                            function get_news_datatable(){
                                table = $('.news_datatable').DataTable({ 
                                    ...
                                    "ajax": {
                                       "url": "<?= site_url(); ?>api/news/list_news_datatable",
                                       "type": "POST"
                                    },
                                    "columnDefs": [
                                        { 
                                    ...
                                    if(id){
                                        alertify.confirm("<?= lang('are_you_sure'); ?>", "<?= lang('do_you_want_to_delete_news'); ?>", function(){
                                            $.ajax({
                                                ...
                                                type: "post",
                                                dataType: 'json',
                                                url: "<?= site_url() ?>api/news/delete_news_details",
