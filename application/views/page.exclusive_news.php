                ...
                <div class="row">
                    <div class="tg-blogpost tg-blogpostvtwo tg-bglight" style="padding-top: 120px;">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <h3 class="text-center"><?= lang('exclusive_news'); ?></h3>
                            <div class="grid-sizer"></div>
                            <?php
                                if(!empty($exclusive_news)){
                                    foreach($exclusive_news as $post){
                            ?>
                                <div class="tg-post tg-masonrygrid">
                                        ...
                                        ?>
                                        <figure>
                                            <a href="<?= site_url() ?>exclusive_news/view/<?= $post['rand_id']; ?>"><img src="<?= S3_URL.S3_BUCKET_NAME ?>/images/<?= $post['s_thumbnail']; ?>" alt="image description"></a>
                                        </figure>
                                        <?php
                                            }
                                        ?>
                                    <div class="tg-postcontent">
                                        <div class="tg-posttitle">
                                            <h3><a href="<?= site_url() ?>exclusive_news/view/<?= $post['rand_id']; ?>"><?= $post['news_title']; ?></a></h3>
                                        </div>
