...
<head>
    ...
    <title><?= lang('Reset your account password') ?></title>
</head>
                ...
                <table style="font-family: 'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif;  line-height: 1.6; width: 100%; margin: 0; padding: 0;">
                    <tr style="font-family: 'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif;  line-height: 1.6; margin: 0; padding: 0;">
                        <td style="font-family: 'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif;  line-height: 1.6; margin: 0; padding: 0;">
                            <p style="font-family: 'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6; font-weight: normal; margin: 0 0 0px; padding: 0;" class=''><?= lang('email_dear') ?> <strong><?= ucwords($to_user_name); ?></strong>,</p>
                            <br />
                            <p style="font-family: 'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6; font-weight: normal; margin: 0 0 10px; padding: 0;" class=''><?= lang('forgot_password_email_text_1'); ?> </p>
                            <p style="font-family: 'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6; font-weight: normal; margin: 0 0 10px; padding: 0;" class=''><?= lang('forgot_password_email_text_2'); ?> </p>
                            <p style="font-family: 'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6; font-weight: normal; margin: 0 0 10px; padding: 0;" class=''><?= lang('forgot_password_email_text_3'); ?> </p>
                            <br>
                            <strong><a href="<?= site_url() ?>users/reset_password/<?= $verify_token; ?>" style="padding:15px;text-decoration:none;background: #3572b0;color:#fff;"><?= lang("reset_password"); ?></a></strong>
