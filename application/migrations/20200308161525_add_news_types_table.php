...
class Migration_Add_News_Types_Table extends CI_Migration
{
    public $_table_name = 'news_types';
    ...
    public function up()
    {
        ...
        $fields = array(
                'news_type_id' => array('type' => 'bigint', 'constraint' => 20, 'auto_increment' => TRUE, 'null' => false),
                'rand_id' => array('type' => 'varchar', 'constraint' => 255),
                'news_type_title' => array('type' => 'varchar', 'constraint' => 255),
                'news_type_desc' => array('type' => 'text','null' => true),
        ...
        $this->dbforge->add_key('news_type_id', TRUE);
        //First create categories_groups
        $this->dbforge->create_table($this->_table_name, true, array('comment' => "'News types table'", 'engine' => 'InnoDB'));
