...
class Migration_Add_Subscribers_Table extends CI_Migration
{
    public $_table_name = 'subscribers';
    ...
    public function up()
    {
        ...
        $fields = array(
            ...
            'status' => array('type' => 'ENUM("0","1")', 'default' => '0', 'null' => false),
        ...
        $this->dbforge->create_table($this->_table_name, true, array('comment' => "'Subscribers table'", 'engine' => 'InnoDB'));
