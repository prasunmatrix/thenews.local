...
class Migration_Add_Visitor_Statistics_Table extends CI_Migration
{
    public $_table_name = 'visitor_statistics';
    ...
    public function up()
    {
        ...
        $fields = array(
                'v_stat_id' => array('type' => 'bigint', 'constraint' => 20, 'auto_increment' => TRUE, 'null' => false),
                ...
                'page_viewed' => array('type' => 'bigint', 'constraint' => 20),
        ...
        $this->dbforge->add_key('v_stat_id', TRUE);
        //First create categories_groups
        $this->dbforge->create_table($this->_table_name, true, array('comment' => "'Visitor statistics table'", 'engine' => 'InnoDB'));
