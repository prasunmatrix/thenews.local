...
class Migration_Add_Epaper_Table extends CI_Migration
{
    public $_table_name = 'epaper';
    ...
    public function up()
    {
        ...
        $fields = array(
                'epaper_id' => array('type' => 'bigint', 'constraint' => 20, 'auto_increment' => TRUE, 'null' => false),
                'rand_id' => array('type' => 'varchar', 'constraint' => 255),
                'epaper_title' => array('type' => 'varchar', 'constraint' => 255),
                'epaper_date' => array('type' => 'date', 'null' => false),
        ...
        $this->dbforge->add_key('epaper_id', TRUE);
        //First create categories_groups
        $this->dbforge->create_table($this->_table_name, true, array('comment' => "'Epaper table'", 'engine' => 'InnoDB'));
