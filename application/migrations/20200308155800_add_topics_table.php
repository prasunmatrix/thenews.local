...
class Migration_Add_Topics_Table extends CI_Migration
{
    public $_table_name = 'topics';
    ...
    public function up()
    {
        ...
        $fields = array(
                'topic_id' => array('type' => 'bigint', 'constraint' => 20, 'auto_increment' => TRUE, 'null' => false),
                'rand_id' => array('type' => 'varchar', 'constraint' => 255),
                'topic_name' => array('type' => 'varchar', 'constraint' => 255),
                'class_name' => array('type' => 'varchar', 'constraint' => 255),
        ...
        $this->dbforge->create_table($this->_table_name, true, array('comment' => "'Topics table'", 'engine' => 'InnoDB'));
