...
class Migration_Add_Blogs_Table extends CI_Migration
{
    public $_table_name = 'blogs';
    ...
    public function up()
    {
        ...
        $fields = array(
                'blog_id' => array('type' => 'bigint', 'constraint' => 20, 'auto_increment' => TRUE, 'null' => false),
                'rand_id' => array('type' => 'varchar', 'constraint' => 255),
                'blog_title' => array('type' => 'varchar', 'constraint' => 255),
                'blog_image' => array('type' => 'varchar', 'constraint' => 255),
                'blog_s_image' => array('type' => 'varchar', 'constraint' => 255),
                'blog_l_image' => array('type' => 'varchar', 'constraint' => 255),
                'blog_desc' => array('type' => 'text'),
                'seo_title' => array('type' => 'varchar', 'constraint' => 255),
                ...
                'date_modified' => array('type' => 'bigint'),
                'user_created' => array('type' => 'bigint'),
                'user_modified' => array('type' => 'bigint')
        );
      
        $this->dbforge->add_field($fields);
        $this->dbforge->add_key('blog_id', TRUE);
        //First create categories_groups
        $this->dbforge->create_table($this->_table_name, true, array('comment' => "'Blogs table'", 'engine' => 'InnoDB'));
