...
class Migration_Add_Videos_Table extends CI_Migration
{
    public $_table_name = 'videos';
    ...
    public function up()
    {
        ...
        $fields = array(
                'video_id' => array('type' => 'bigint', 'constraint' => 20, 'auto_increment' => TRUE, 'null' => false),
                'rand_id' => array('type' => 'varchar', 'constraint' => 255),
                'video_title' => array('type' => 'varchar', 'constraint' => 255),
                'video_desc' => array('type' => 'text','null' => true),
                'video_url' => array('type' => 'text','null' => true),
        ...
        $this->dbforge->create_table($this->_table_name, true, array('comment' => "'Videos table'", 'engine' => 'InnoDB'));
