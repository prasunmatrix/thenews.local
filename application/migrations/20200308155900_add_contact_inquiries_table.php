...
class Migration_Add_Contact_Inquiries_Table extends CI_Migration
{
    public $_table_name = 'contact_inquiries';
    ...
    public function up()
    {
        ...
        $fields = array(
                'inq_id' => array('type' => 'bigint', 'constraint' => 20, 'auto_increment' => TRUE, 'null' => false),
                ...
                'mobile_no' => array('type' => 'varchar', 'constraint' => 255),
                'subject' => array('type' => 'varchar', 'constraint' => 255),
                'desc' => array('type' => 'text'),
                'read' => array('type' => 'ENUM("0","1")', 'default' => '0', 'null' => false),
        ...
        $this->dbforge->add_key('inq_id', TRUE);
        //First create categories_groups
        $this->dbforge->create_table($this->_table_name, true, array('comment' => "'Contact Inquries table'", 'engine' => 'InnoDB'));
