    ...
    <head>
        ...
        <style>
            ...
            :root {
              ...
              --animation-sentence: 'You know youre supposed to leave, right?';
    ...
    <body>
        ...
        <script>
            ...
            const grantAccess = () => {
              ...
              heading.textContent = 'Unauthorised';
              paragraph.textContent = "This is private area. You're not authorised to view this page.";
